      ...
      setProducts([
        {
          ...
          description: "Botellas PET limpias y comprimidas",
        },
        {
          id: 2,
          ...
          description: "HDPE disponible para retiro inmediato",
        },
        {
          id: 3,
          ...
          description: "Lote clasificado y separado",
        },
        {
          id: 4,
          seller: "Ana López",
          ...
          description: "Material limpio y separado por color",
        },
      ]);
    } else {
      setProducts(
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              Conectamos recicladores con centros de acopio para crear un
              mercado sostenible de botellas plásticas reciclables.
            </p>
            <div className="flex gap-4 flex-wrap">
              <Link to="/auth">
                <Button size="lg" className="bg-primary hover:bg-green-600">
                  Comenzar Ahora
                </Button>
              </Link>
              <Button size="lg" variant="outline" onClick={scrollToMarketplace}>
                Conocer Más
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explora las ofertas disponibles de recicladores verificados
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Mercado transparente donde recicladores y centros de acopio establecen precios competitivos",
              },
              {
                icon: Users,
                title: "Comunidad Activa",
                desc: "Conecta con una red de recicladores comprometidos y centros de acopio certificados",
              },
              {
                icon: Leaf,
                title: "Impacto Ambiental",
                desc: "Cada botella reciclada contribuye a reducir la contaminación y proteger nuestro planeta",
              },
            ].map((f, i) => (
              <Card
                key={i}
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-8 md:p-12 text-white text-center space-y-6">
          ...
          <p className="text-lg opacity-90">
            Las botellas plásticas tardan hasta 450 años en descomponerse.
          </p>
          <Link to="/auth">
            <Button
              size="lg"
      ...
      <footer id="contacto" className="border-t bg-gray-50 py-8">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>
            &copy; 2026 Mercado verde. Proyecto universitario de impacto
            ambiental.
          </p>
        </div>
      </footer>
      ...
      <Dialog open={showProductModal} onOpenChange={setShowProductModal}>
        <DialogContent
          ...
          style={{ width: "60vw", maxWidth: "80vw", height: "70vh" }}
        >
          <DialogTitle className="sr-only">Detalles del producto</DialogTitle>

          <DialogDescription className="sr-only">
            Información del producto y opciones para comprar o contactar al
            vendedor.
          </DialogDescription>
          {selectedProduct && (
            <div className="grid grid-cols-2 min-h-[500px]">
              ...
              <div className="p-6 space-y-4 border-r">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {selectedProduct.quantity.toLocaleString()} botellas
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">
              ...
              <div className="p-6 space-y-4 bg-gray-50 flex flex-col justify-center">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Inicia sesión o crea una cuenta para realizar la compra y
